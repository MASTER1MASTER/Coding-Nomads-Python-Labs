...
short_story = """You would never guess what can happen when you jump into a seemingly shallow puddle at night time!
...
But when I realised I was mistaken and that the best approach to vanquish the most evil of all was...UPS! Suddenly i woke up and found myself  floating.  Disoriented, I flailed my arms, limbs meeting only air. Panic surged through me, but then I realized I wasn't falling. Confused, I sat up...
"""
...
# Split the text into words, translate to Pig Latin, and join back into a string
translated_text = ' '.join(pig_latin(word) for word in short_story.split())
